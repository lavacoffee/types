...
/** Filters options */
export interface OutgoingFilters extends Filters {
    /** The player guild id */
    guildId: string
}

/** Filters payload */
export interface OutgoingPayloadFilters extends OutgoingPayloadBase, OutgoingFilters {
    op: "filters"
}
